...
interface Props {
  data: IUser[];
  handleEdit: (user: IUser) => void; // Función para editar usuario
  handleDelete: (user: IUser) => void; // Función para eliminar usuario
  ...
  return (
    <div className="w-full">
      <div className="flex items-center justify-between py-4">
        ...
        />
        <Button onClick={handlePropOpen}>Create New User</Button>
      </div>
